...
try:
    ...
    channelidopen.write('Here you have to put the channel ID you want to put the welcome commands in. Replace all the text here with the channel ID.')
...
async def on_member_remove(member):
 channel=client.get_channel(channelidopen)
